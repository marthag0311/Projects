...
SELECT 
    ...
    Customer_ID as customer_key,
    pho.phone_key as phone_key, 
    inte.internet_key as internet_key, 
    onl.online_key as online_key, 
    dev.plan_key as plan_key, 
    stre.streaming_key as streaming_key,
    con.contract_key as contract_key, 
    sta.status_key as status_key, 
