...
-- =============================================================================
IF OBJECT_ID('data_mart.fact_customer_metrics', 'V') IS NOT NULL
    DROP VIEW data_mart.fact_customer_metrics;
GO

CREATE VIEW data_mart.fact_customer_metrics AS 
SELECT
...
-- =============================================================================
IF OBJECT_ID('data_mart.dim_demographics', 'V') IS NOT NULL
    DROP VIEW data_mart.dim_demographics;
GO

CREATE VIEW data_mart.dim_demographics AS 
SELECT
    customer_id,
    gender,
    married,
...
-- =============================================================================
IF OBJECT_ID('data_mart.dim_account', 'V') IS NOT NULL
    DROP VIEW data_mart.dim_account;
GO

CREATE VIEW data_mart.dim_account AS 
SELECT 
    customer_id,
    tenure_in_months,
    case
...
-- =============================================================================
IF OBJECT_ID('data_mart.dim_services', 'V') IS NOT NULL
    DROP VIEW data_mart.dim_services;
GO

CREATE VIEW data_mart.dim_services AS 
SELECT 
    customer_id,
    unlimited_data,
    internet_service,
